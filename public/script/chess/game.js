...
export default class Game {
    ...
    firstSelectionCall(square) {
        ...
        this.paintSquares(this.possibleMoves);
    }
    ...
    secondSelectionCall(target, invokedByDragAndDrop = false) {
        ...
        if (arrayNotEmpty && legalMoveSelected) {
            ...
            this.state.boardMap.get(positionClicked)
    ...
    renderOpponentPlay(oldPosition, newPosition) {
